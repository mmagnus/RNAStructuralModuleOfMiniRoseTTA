...
# List or residues, 5x [A, ..] 
# Atom
# The atom's group index as an integer, which is used to identify groups of connected atoms
# The (x, y, z) coordinates of the atom as a tuple of three floats
ideal_coords = [
    [ # 27 A #0
